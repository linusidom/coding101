...
directory = os.path.join(os.getcwd(), "files/fonts")
# print(directory)
"""
CONSTANTS
"""
...
REGULAR_FONT_NAME = 'tahoma'
BOLD_FONT_NAME = 'tahoma'
ITALIC_FONT_NAME = 'tahoma'
BOLDITALIC_FONT_NAME = 'tahoma'
...
"""
pdfmetrics.registerFont(TTFont('tahoma', REGULAR_FONT_FILE))
pdfmetrics.registerFont(TTFont('tahoma', BOLDITALIC_FONT_FILE))
pdfmetrics.registerFont(TTFont('tahoma', BOLD_FONT_FILE))
pdfmetrics.registerFont(TTFont('tahoma', ITALIC_FONT_FILE))
